...
tags = ["Go", "数据类型"]
categories = ["教程"]
summary = "详解Go八大基本数据类型：布尔、数字、字符串、数组、切片、映射、结构体、接口"
weight = 4
+++
...
整数包括有符号和无符号两种，有符号包括int8、int16、int32、int64，无符号包括uint8、uint16、uint32、uint64。
...
布尔值只有两个，true和false。一般用于条件判断，和状态表示。
